export default {
  ...
  'form.password.prompt': 'Choose a password',
  'form.required#one': 'Must be at least 1 character',
  'form.required#other': 'Must be at least {count} characters',
  ...
  'error.common.description':
    'Something went wrong. The app may not work properly',
